          ...
          >
            ...
            <motion.div custom={0} variants={fadeUp} className="inline-flex items-center gap-2">
              <span className="relative flex h-2.5 w-2.5">
                ...
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-sage-500 pulse-dot" />
              </span>
              <span className="text-xs font-semibold text-sage-600 dark:text-sage-400 bg-sage-300/30 dark:bg-sage-700/30 border border-sage-300 dark:border-sage-600 rounded-full px-3 py-0.5 tracking-wide">
                Open to Work
              </span>
            </motion.div>
            ...
            {/* Role */}
            <motion.p custom={2} variants={fadeUp} className="text-sage-600 dark:text-sage-400 text-lg font-semibold tracking-wide">
            ...
            <motion.div custom={4} variants={fadeUp} className="flex flex-wrap gap-4 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-sage-500 hover:bg-sage-600 text-white text-sm font-semibold rounded-xl transition-colors shadow-sm"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[var(--card)] border border-[var(--border)] text-[var(--foreground)] text-sm font-semibold rounded-xl hover:border-sage-400 transition-colors"
              >
