...
const socials = [
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/sanyasachdeva",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "Twitter / X",
    href: "https://twitter.com/sanyasachdeva",
    icon: (
...
export default function LeftSidebar() {
  return (
    <motion.aside
      ...
      className="fixed left-4 bottom-0 hidden lg:flex flex-col items-center gap-4 z-40"
    ...
    >
      {socials.map((social) => (
        <a
          ...
          className="text-zinc-400 hover:text-sage-500 dark:hover:text-sage-400 transition-colors p-1"
        >
          {social.icon}
        </a>
      ))}
