        ...
        {projects.map((project, i) => (
          ...
          >
              ...
              {project.tags.map((tag) => (
                <span
                  ...
                  style={{
                    ...
                    color: "var(--accent)",
                    border: "1px solid rgba(180,183,172,0.4)",
                  }}
                >
                  {tag}
                </span>
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-[var(--accent)] hover:opacity-70 transition-opacity mt-1"
            >
